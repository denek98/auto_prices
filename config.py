...
# БАСМАРКЕТ и КИАПАРТС нужно пересохранять
...
# ----------------------------------------------------------------------------------------------------
    'busmarket': {
        'supplier_folder': 'БасМаркет',
        'output_filename': 'busmarket.csv',
        'Количество бесполезных строк': 1,
        'supplier_columns_dict': {
            'Производитель': 3,
            'Артикул': 2,
            ...
            'Количество 0 дней': [13],
            'Количество 1 дней': [6],
            'Количество 2 дней': [7,8,9,10,11,12,14,15],
            'Название': 4,
            'Множитель цены': 1,
        }
    },
# ----------------------------------------------------------------------------------------------------
# Конец Секции БасМаркет
# ----------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------
# Начало Бастион
# ----------------------------------------------------------------------------------------------------
    'bastion': {
        'supplier_folder': 'Бастион',
        'output_filename': 'bastion.csv',
        'Количество бесполезных строк': 56,
        'supplier_columns_dict': {
            'Производитель': 2,
            'Артикул': 4,
            'Цена': 6,
            'Количество 0 дней': [12],
            'Количество 1 дней': [7],
            'Количество 2 дней': [8],
            'Название': 1,
            'Множитель цены': 1,
...
# ----------------------------------------------------------------------------------------------------
# Конец Секции Бастион
# ----------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------
# Начало Авто Техникс
# ----------------------------------------------------------------------------------------------------
    'avtotechnics': {
        'supplier_folder': 'АвтоТехникс',
        'output_filename': 'avtotechnics.csv',
        'Количество бесполезных строк': 1,
        'supplier_columns_dict': {
            'Производитель': 1,
            'Артикул': 12,
            'Цена': 4,
            'Количество 0 дней': [5,6],
            'Количество 1 дней': [7,8,9,10,11],
            'Количество 2 дней': [],
            'Название': 3,
            'Множитель цены': 1,
        }
...
# ----------------------------------------------------------------------------------------------------
# Конец Секции Авто Техникс
# ----------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------
# Начало Секции АВД Трейд
# ----------------------------------------------------------------------------------------------------
    'avdtrade': {
        'supplier_folder': 'АвдТрейд',
        'output_filename': 'avdtrade.csv',
        'Количество бесполезных строк': 2,
        'supplier_columns_dict': {
            'Производитель': 3,
            'Артикул': 2,
            ...
            'Количество 2 дней': [6],
            'Название': 4,
            'Множитель цены': 31.98,
        }
    },
# ----------------------------------------------------------------------------------------------------
# Конец Секции АВД Трейд
# ----------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------
# Начало Секции Бровакар
# ----------------------------------------------------------------------------------------------------
    'brovacar': {
        'supplier_folder': 'БроваКар',
        'output_filename': 'brovacar.csv',
        'Количество бесполезных строк': 8,
        'supplier_columns_dict': {
            'Производитель': 3,
            'Артикул': 14,
